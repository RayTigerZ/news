...
<html>
  ...
  <body>
    <form action="/news/servlet/UserServlet?type=registeCheck" id="myform" method="post">
	 ...
	 <table align="center" border='1'>     
	   	<tr>	
	   		<td width="200"><input type="button"  value="删除所选项" onclick="deleteUsers();"></td>	
