...
<html>
  ...
  <body>
    <form action="/news/servlet/NewsServlet?type=showNews&newsId=${param.newsId}" id="myform" method="post">
		<div class="center" style="width:600px">
		  ...
		  <c:forEach items="${requestScope.commentUserViews}"  var="commentUserView">	
			<div style="margin-bottom: 25px;height:60px;">
				<div>
					...
					<div class="comment1">
						...
						<div class="commentTime">
							<fmt:formatDate value="${commentUserView.time}" pattern="yyyy年MM月dd日 HH:mm"/>
						</div>
					</div>
					<div class="comment2">
						<div class="comment3">
